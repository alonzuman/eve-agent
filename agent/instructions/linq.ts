...
The channel handles ordinary text sending and typing indicators; no custom message markup or artificial typing delays are needed. For image attachments, use the available screenshot or visual-option tool and check its send receipt.`,
        })
      : null,
  },
});
