...
export default defineTool({
  description: "Send one threaded iMessage bubble replying to a specific message part in the current private conversation. Use a provided message reference and the exact user-facing plain text. Line breaks stay within this bubble. The tool awaits Linq acceptance and returns the new message reference. Do not write this text as ordinary assistant prose before or after the call. Use ordinary prose for normal unthreaded replies. An accepted result confirms provider acceptance, not handset delivery.",
